    ...
    extends SignInRewardColumn
{
    ...
    public boolean overrideDefaultRewards() {
        ...
        if (ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Override-default-rewards")) {
            return ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).getBoolean("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Override-default-rewards");
        }
        return false;
    }
    ...
    public List<String> getMessages() {
        ...
        if (ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Messages")) {
            return ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).getStringList("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Messages");
        }
    ...
    public List<String> getBroadcastMessages() {
        if (!isAvailable()) return new ArrayList<>();
        if (ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).contains("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Broadcast-Messages")) {
            return ConfigurationUtil.getConfig(ConfigurationType.REWARD_SETTINGS).getStringList("Reward-Settings.Permission-Groups." + group.getGroupName() + ".Statistics-Times-Of-Month." + settings + ".Broadcast-Messages");
        }
        return new ArrayList<>();
    }
